...
| Label | What it means |
|-------|--------------|
| `good first issue` | Low complexity — good entry point for new contributors |
| `help wanted` | We want input or a PR — any experience level |
| `roadmap` | Planned work — not yet assigned or scoped |
